      ...
      <div class="flex justify-between mb-2">
        ...
        <div class="mr-8 px-3">
          <div class="flex items-center w-4 mr-2">
            <button class="flex items-center mr-2" alt="Comment Count">
              <svg
              ...
              <span class="text-ghDark-light h-6 px-1">0 comments</span>
            </button>
            <button class="flex items-center" alt="Comment Count">
              <svg 
                xmlns="http://www.w3.org/2000/svg" 
                fill="none" 
                viewBox="0 0 24 24" 
              ...
              <span class="text-ghDark-light h-6 px-1">0 saves</span>
            </button>
          </div>
        </div>
      </div>
