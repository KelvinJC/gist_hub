    ...
    <div>
      <%= if @form do %>
        ...
        <div class="flex mr-2">
          <input
            type="text"
            class="rounded-l-lg bg-ghDark-dark border-white py-1 focus:outline-none focus:border-ghLavender
                  focus:ring-0 placeholder-ghDark-light text-white text-sm font-brand font-regular"
            placeholder="Search..."
